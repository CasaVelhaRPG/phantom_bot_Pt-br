$.lang.register('randomcommand.1', '(sender) foi jogado em um grande poço de PJSalt');
$.lang.register('randomcommand.2', 'Oh my, (sender) você me faz só querer *SLURP SLURP SLURP*');
$.lang.register('randomcommand.3', '(sender) foi jogado em um poço de prazerosos tentáculos.');
$.lang.register('randomcommand.4', '(sender) foi jogado em um poço de super leões geneticamente modificados.');
$.lang.register('randomcommand.5', '(sender) foi jogado em um poço de explosivos prinnies.');
$.lang.register('randomcommand.6', 'Eu quero vocÊ (sender).');
$.lang.register('randomcommand.7', '/eu joguei (sender) em um poço de PJSalt');
$.lang.register('randomcommand.8', 'Dango, dango, dango, dango, big (sender) family~\u266B');
$.lang.register('randomcommand.9', 'O que nós vamos\' fazer na cama (sender)?');
$.lang.register('randomcommand.10', 'Sua mãe era um hamster e seu pai cheirava a sabugueiro!');
$.lang.register('randomcommand.11', 'Quando a vida lhe der limões (sender), faça suco de laranja e deixe o mundo imaginando como diabos você fez isso.');
$.lang.register('randomcommand.12', '(sender) foi violado por um monstro tentáculo!');
$.lang.register('randomcommand.13', '/me licked (sender). . .');
$.lang.register('randomcommand.14', 'Esta é a primeira vez (sender) notou o cheiro de uma mulher..');
